...
zip_path = current_dir+"/data/chroma_lawdb_kanana_clustered.zip"
extract_path = current_dir+"/data/chroma_lawdb_kanana_clustered"

# 이미 압축 해제되어 있으면 건너뛰기
if not os.path.exists(extract_path) or not os.listdir(extract_path):
    with zipfile.ZipFile(zip_path, 'r') as zip_ref:
        zip_ref.extractall(extract_path)
    print("[INFO] Chroma ZIP extracted:", extract_path)
else:
